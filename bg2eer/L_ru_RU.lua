uiStrings = {
	...
	PLAY_SOUND_BUTTON = "ВОСПРОИЗВЕСТИ",
	...
	SOUND_BUTTON = "ЗВУК",
	SOUND_DESCRIPTION = "Здесь можно выбрать любой набор звуковых файлов из списка для озвучивания персонажа. Кнопка «Воспроизвести» позволяет услышать некоторые фразы из набора.",
	SOUNDS_BUTTON = "ГОЛОС",
	SOUND_TITLE = "Звук",
