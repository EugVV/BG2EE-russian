uiStrings = {
	...
	CHARMAN_CONFIMDELETE_LABEL = "Действительно удалить этого персонажа?",
	...
	ENABLE_CLOUD_DESCRIPTION = "Использовать сохранение в облаке.",
	...
	GLYPHS_CHARACTERS = "АБВГДЕËЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ|абвгдеëжзийклмнопрстуфхцчшщъыьэюя",
	GLYPHS_SYMBOLS = "!\"#$%&'()*+,-./0123456789:;<=>?@[\\]^_`{|}~",
	GLYPHS_SYMBOLS_CJK = "。「」！？",
	GLYPHS_SYMBOLS_EXT = "¡©«¬®»¿‘’‚‛“”„‟…‹›",
	...
	IMPORT_FOLDER_LABEL = "Папка с данными",
	IMPORT_FOLDER_TOOLTIP = "Выбор папки с данными. Здесь будут храниться пользовательские файлы, такие как сохранённые игры. Другие пользовательские папки, например «portraits» и «override», после импорта будут скопированы из этого каталога в файлы игры.",
	IMPORT_GAME_BUTTON = "ИМПОРТ ИГРЫ",
	IMPORT_PROGRESS_LABEL = "Импорт файлов",
	IMPORT_RULES_TOOLTIP = "Определяет, что игрокам позволено перенести в игру при импорте персонажа",
	IMPORT_SELECT_BUTTON = "Выбрать папку",
	IMPORT_TITLE = "Импорт",
	...
	MANAGE_CHAR_BUTTON = "Управление персонажами",
	MANAGE_CHAR_TEXT = "Управление персонажами",
	...
	MUTE_PLAYER_TITLE = "Видимость плеера",
	NAME_BUTTON = "ИМЯ",
	NAME_LABEL = "Имя",
	...
	NO_EXPORT_TEXT = "Персонажи отсутствуют.",
	...
	RESTART_BUTTON = "ПЕРЕЗАПУСК ИГРЫ",
	RESTART_LABEL = "Перезапуск игры",
	REST_BUTTON = "ОТДЫХ",
	...
	STORE_LABEL = "Магазин",
	STRENGTH_LABEL = "Сила",
	STRREF_ERROR_WIFI_DISABLED = "Wi-Fi отключен",
	STRREF_GUI_COPY = "Скопировать",
	...
	STRREF_GUI_MIXED_MINUTEPLURALFORMAT = "<MINUTE> минут",
	STRREF_GUI_MIXED_MINUTESINGULARFORMAT = "<MINUTE> минута",
	STRREF_GUI_PASTE = "Вставить",
	STRREF_INFO_WIFI_DISCONNECT = "Нет соединения Wi-Fi",
	TARGET_LABEL = "Цель",
	TARGET_NORMAL = "Цель",
